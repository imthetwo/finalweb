      ...
      <div className="mx-auto max-w-[700px] px-4 text-center md:px-8">
        ...
        <form onSubmit={handleSubmit} className="mt-10 flex flex-col gap-3 sm:flex-row">
          <input
            ...
            required
            className="flex-1 border border-white/10 bg-white/4 px-5 py-3.5 text-sm text-white placeholder:text-zinc-600 outline-none transition-colors focus:border-[#00ffff]/40 focus:bg-[#00ffff]/4"
          />
          <button
            type="submit"
            disabled={loading}
            className="inline-flex items-center justify-center gap-2 bg-[#00ffff] px-7 py-3.5 text-sm font-black uppercase tracking-[0.2em] text-black transition-all duration-200 hover:shadow-[0_0_30px_rgba(0,255,255,0.35)] disabled:opacity-60"
          >
            <Send size={14} />
