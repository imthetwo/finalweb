...
export const BUILD_SLOTS: SlotCfg[] = [
  {
    ...
    specs: [
      ...
      { key: "ramGen", label: "RAM Gen" },
      { key: "formFactor", label: "Form Factor" },
      { key: "ramSlots", label: "RAM Slots", fmt: (v) => v ? `${v} slots` : "—" },
    ],
  },
  {
  ...
  },
  {
    ...
    specs: [
      { key: "ramGen", label: "Gen" },
      { key: "ramSpeedMhz", label: "Speed", fmt: (v) => v ? `${v} MHz` : "—" },
    ],
  },
  {
  ...
  },
  {
    ...
    specs: [
      { key: "tdp", label: "TDP", fmt: (v) => v ? `${v}W` : "—" },
      { key: "gpuLengthMm", label: "Length", fmt: (v) => v ? `${v}mm` : "—" },
    ],
  },
  {
    ...
    specs: [
      { key: "formFactor", label: "Form Factor" },
      { key: "maxGpuLengthMm", label: "Max GPU", fmt: (v) => v ? `${v}mm` : "—" },
    ],
  },
  {
  ...
  },
  {
    ...
    specs: [
      { key: "socketSupport", label: "Sockets" },
      { key: "tdp", label: "TDP Rating", fmt: (v) => v ? `${v}W` : "—" },
    ],
  },
  {
