...
export const metadata = { title: "Support | Pecify" };
...
export default function SupportPage() {
  return (
    <InfoPage
      ...
      sections={[
        { heading: "Contact", body: "Email support@pecify.tech or call +84 900 000 000. Live chat is available via the AI assistant in the bottom-right corner of every page." },
