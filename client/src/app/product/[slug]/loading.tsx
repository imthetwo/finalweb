    ...
    <main className="min-h-screen bg-black px-4 py-10 text-white md:px-8">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2">
        ...
        <div className="space-y-4 pt-2">
          {/* Brand */}
          <div className="h-3 w-20 overflow-hidden rounded bg-zinc-800">
          ...
          <div className="space-y-2">
            <div className="h-8 w-4/5 overflow-hidden rounded bg-zinc-800">
              <div className="h-full w-full animate-shimmer bg-gradient-to-r from-zinc-800 via-zinc-700 to-zinc-800 bg-[length:200%_100%]" />
            </div>
            <div className="h-8 w-1/2 overflow-hidden rounded bg-zinc-800">
              <div className="h-full w-full animate-shimmer bg-gradient-to-r from-zinc-800 via-zinc-700 to-zinc-800 bg-[length:200%_100%]" />
            </div>
          </div>

          {/* Category */}
          <div className="h-4 w-32 overflow-hidden rounded bg-zinc-800">
            <div className="h-full w-full animate-shimmer bg-gradient-to-r from-zinc-800 via-zinc-700 to-zinc-800 bg-[length:200%_100%]" />
          </div>

          {/* Price */}
          <div className="mt-6 h-10 w-48 overflow-hidden rounded bg-zinc-800">
            <div className="h-full w-full animate-shimmer bg-gradient-to-r from-zinc-800 via-[#00ffff]/10 to-zinc-800 bg-[length:200%_100%]" />
          </div>

          {/* Stock */}
          <div className="h-4 w-28 overflow-hidden rounded bg-zinc-800">
            <div className="h-full w-full animate-shimmer bg-gradient-to-r from-zinc-800 via-zinc-700 to-zinc-800 bg-[length:200%_100%]" />
          </div>
          ...
          <div className="mt-6 flex items-stretch gap-3">
            <div className="h-12 flex-1 overflow-hidden bg-zinc-800">
              <div className="h-full w-full animate-shimmer bg-gradient-to-r from-zinc-800 via-[#00ffff]/10 to-zinc-800 bg-[length:200%_100%]" />
            </div>
            <div className="h-12 w-12 overflow-hidden border border-zinc-700 bg-zinc-900">
