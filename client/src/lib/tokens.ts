/**
 * Design tokens — bảng màu duy nhất của Pecify Store.
 *
 * Dùng cho:
 *   - Inline styles (style={{ color: colors.brand }})
 *   - className động (className={`bg-[${colors.elevated}]`})
 *   - Nơi không thể dùng Tailwind class trực tiếp
 *
