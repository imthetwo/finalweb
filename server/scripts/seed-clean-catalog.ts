...
async function main() {
  ...
  const cpus = [
    ...
    { folder: 'cpu', file: '14600k-tray.jpg', name: 'Intel Core Ultra 5 245K', brand: 'Intel', price: 7990000, socket: 'LGA1851', cores: 14, threads: 14, baseClockGhz: 4.2, boostClockGhz: 5.2, tdp: 125, cacheL3: '24MB', generation: 'Core Ultra 200' },
    ...
    { folder: 'cpu', file: '14700-tray.jpg', name: 'AMD Ryzen 7 9800X3D', brand: 'AMD', price: 12990000, socket: 'AM5', cores: 8, threads: 16, baseClockGhz: 4.7, boostClockGhz: 5.2, tdp: 120, cacheL3: '96MB', generation: 'Ryzen 9000' },
  ];
  for (const p of cpus) {
  ...
  // ─── GPU ──────────────────────────────────────────────────────────────────
  const gpus = [
    { folder: 'gpu', file: 'asus_rtx-4080-strix.png', name: 'NVIDIA GeForce RTX 4090 Founders Edition', brand: 'NVIDIA', price: 42990000, sale: 39990000, vramGb: 24, tdp: 450, lengthMm: 336, pcieGen: 4, boostClockMhz: 2520, memType: 'GDDR6X' },
    ...
    { folder: 'gpu', file: 'asus_rtx-4080-strix.png', name: 'MSI GeForce RTX 4070 Ti SUPRIM X', brand: 'MSI', price: 18990000, vramGb: 12, tdp: 285, lengthMm: 340, pcieGen: 4, boostClockMhz: 2760, memType: 'GDDR6X' },
    { folder: 'gpu', file: 'gigabyte_rx-7900-xt.png', name: 'AMD Radeon RX 7900 XTX', brand: 'AMD', price: 22990000, sale: 20990000, vramGb: 24, tdp: 355, lengthMm: 287, pcieGen: 4, boostClockMhz: 2615, memType: 'GDDR6' },
    ...
    { folder: 'gpu', file: 'gigabyte_rx-7900-xt.png', name: 'NVIDIA GeForce RTX 3080 iCHILL Black', brand: 'NVIDIA', price: 12990000, sale: 10990000, vramGb: 10, tdp: 320, lengthMm: 305, pcieGen: 4, boostClockMhz: 1710, memType: 'GDDR6X' },
  ];
  for (const p of gpus) {
  ...
  const motherboards = [
    ...
    { folder: 'motherboard', file: '47937.png', name: 'MSI PRO B760M-A WIFI DDR4', brand: 'MSI', price: 2990000, socket: 'LGA1700', chipset: 'B760', formFactor: 'mATX', ramGen: 'DDR4', ramSlots: 4, maxRamGb: 128 },
  ];
  ...
  const rams = [
    ...
    { folder: 'memory', file: 'DOMINATOR_TITANIUM_WH_Xl95Dvo.2e16d0ba.fill-630x380.format-webp.webp', name: 'Corsair Vengeance RGB DDR5 32GB 6000MHz', brand: 'Corsair', price: 3490000, sale: 2990000, capacityGb: 32, speedMhz: 6000, generation: 'DDR5', latency: 'CL30', kit: '2x16GB' },
    { folder: 'memory', file: '30120.png', name: 'Corsair Vengeance DDR5 32GB 5600MHz', brand: 'Corsair', price: 2790000, capacityGb: 32, speedMhz: 5600, generation: 'DDR5', latency: 'CL36', kit: '2x16GB' },
    ...
    { folder: 'memory', file: '30121.png', name: 'Kingston Fury Beast DDR4 16GB 3600MHz', brand: 'Kingston', price: 1290000, capacityGb: 16, speedMhz: 3600, generation: 'DDR4', latency: 'CL16', kit: '1x16GB' },
  ];
  for (const p of rams) {
  ...
  // ─── STORAGE ──────────────────────────────────────────────────────────────
  // Storage: dùng ảnh RAM làm placeholder vì chưa có ảnh SSD trên Cloudinary
  const storages = [
    { folder: 'memory', file: '30120.png', name: 'Samsung 9100 PRO NVMe M.2 SSD 2TB', brand: 'Samsung', price: 4990000, sale: 4490000, capacityGb: 2000, storageType: 'NVMe', interfaceType: 'PCIe 5.0', readMbps: 14800, writeMbps: 13400 },
    { folder: 'memory', file: '30121.png', name: 'Samsung 990 EVO Plus NVMe M.2 SSD 2TB', brand: 'Samsung', price: 3290000, sale: 2890000, capacityGb: 2000, storageType: 'NVMe', interfaceType: 'PCIe 4.0', readMbps: 7250, writeMbps: 6300 },
    { folder: 'memory', file: '30120.png', name: 'Samsung 870 EVO SATA 2.5" SSD 2TB', brand: 'Samsung', price: 2190000, capacityGb: 2000, storageType: 'SSD', interfaceType: 'SATA', readMbps: 560, writeMbps: 530 },
    { folder: 'memory', file: '30121.png', name: 'Samsung T9 Portable SSD 4TB', brand: 'Samsung', price: 5890000, sale: 5290000, capacityGb: 4000, storageType: 'SSD', interfaceType: 'USB 3.2', readMbps: 2000, writeMbps: 1950 },
  ];
  ...
  const psus = [
    ...
    { folder: 'power-supply', file: 'Etail_C850GoldCore_Carousel_Hero_EN.png', name: 'Corsair RM750x 80+ Gold 750W', brand: 'Corsair', price: 2890000, sale: 2490000, wattage: 750, efficiency: '80+ Gold', modular: 'Full' },
    ...
    { folder: 'power-supply', file: 'Etail_C850GoldCore_Carousel_Hero_EN.png', name: 'Cooler Master MWE Gold 650W', brand: 'Cooler Master', price: 1890000, sale: 1690000, wattage: 650, efficiency: '80+ Gold', modular: 'Non' },
  ];
  for (const p of psus) {
  ...
  const cases = [
    ...
    { folder: 'case', file: 'Etail_H3Flow_WH_Carousel_Hero_EN.png', name: 'Cooler Master Elite 600', brand: 'Cooler Master', price: 1490000, formFactor: 'ATX', maxGpuLengthMm: 330, radiatorSupport: '240mm', driveBays: 3 },
    { folder: 'case', file: 'Case_H9_Flow_RGB__WH_Carousel_Hero_EN_d5c60367-c559-4b2e-9fc1-2fefda287bed.png', name: 'Cooler Master MasterFrame 360', brand: 'Cooler Master', price: 3990000, formFactor: 'ATX', maxGpuLengthMm: 400, radiatorSupport: '360mm', driveBays: 2 },
    { folder: 'case', file: 'Etail_H3Flow_WH_Carousel_Hero_EN.png', name: 'Cooler Master Q300L V2', brand: 'Cooler Master', price: 1290000, sale: 1090000, formFactor: 'mATX', maxGpuLengthMm: 360, radiatorSupport: '240mm', driveBays: 2 },
  ];
  ...
  const coolers = [
    ...
    { folder: 'cpu-cooler', file: '01_Kraken_Plus__RGB_360_white_0191545f-9605-4ef0-aec0-895f4f13b01c.png', name: 'NZXT Kraken 360 RGB Black AIO', brand: 'NZXT', price: 4990000, coolerType: 'AIO', tdpRating: 400, radiatorSizeMm: 360, socketSupport: 'AM5,AM4,LGA1700,LGA1851' },
  ...
  const monitors = [
    ...
    { folder: 'monitor', file: '47387.png', name: 'LG 34" UltraWide QHD 144Hz', brand: 'LG', price: 11990000, sizeIn: 34, resolution: '3440x1440', refreshRateHz: 144, panelType: 'IPS', responseMs: 1.0, hdr: true },
  ];
  ...
  // ─── LAPTOP ───────────────────────────────────────────────────────────────
  // Laptops: dùng ảnh PC case làm placeholder vì chưa có ảnh laptop trên Cloudinary
  const laptops = [
    { folder: 'PCs', file: 'h7-flow-rgb-hero-white.png', name: 'Razer Blade 16 (2024) RTX 4090', brand: 'Razer', price: 69990000, sale: 64990000, cpu: 'Intel Core i9-14900HX', gpu: 'RTX 4090', ramGb: 32, storageGb: 2000, displaySizeIn: 16, displayResolution: '2560x1600', os: 'Windows 11' },
    { folder: 'PCs', file: 'h6-flow-rgb-hero-white.png', name: 'Razer Blade 14 (2024) RTX 4070', brand: 'Razer', price: 54990000, cpu: 'AMD Ryzen 9 8945HX', gpu: 'RTX 4070', ramGb: 16, storageGb: 1000, displaySizeIn: 14, displayResolution: '2560x1600', os: 'Windows 11' },
    { folder: 'PCs', file: 'h7-flow-hero-white.png', name: 'ASUS ROG Zephyrus G16 RTX 4080', brand: 'ASUS', price: 48990000, sale: 45990000, cpu: 'Intel Core Ultra 9 185H', gpu: 'RTX 4080', ramGb: 32, storageGb: 2000, displaySizeIn: 16, displayResolution: '2560x1600', os: 'Windows 11' },
    { folder: 'PCs', file: 'h6-flow-rgb-hero-white.png', name: 'MSI Stealth 16 AI Studio', brand: 'MSI', price: 52990000, cpu: 'Intel Core Ultra 7 155H', gpu: 'RTX 4070 Ti', ramGb: 32, storageGb: 2000, displaySizeIn: 16, displayResolution: '3840x2400', os: 'Windows 11' },
  ];
  ...
  const peripherals: { categoryName: string; items: any[] }[] = [
    { categoryName: 'Case Fans', items: [
      ...
      { folder: 'case-fan', file: 'Etail_F120X_Black_Carousel_Hero_EN.png', name: 'Corsair iCUE LINK RX360 RGB Black', brand: 'Corsair', price: 990000, sale: 790000 },
      { folder: 'case-fan', file: 'Etail_F120X_White_Carousel_Hero_EN.png', name: 'Corsair AF140 Elite White', brand: 'Corsair', price: 690000 },
    ]},
    { categoryName: 'Mechanical Keyboards', items: [
      ...
      { folder: 'keyboard', file: 'g413-se-gallery-4-new.png', name: 'Logitech G213 Prodigy RGB', brand: 'Logitech', price: 990000, sale: 790000 },
    ]},
    ...
    { categoryName: 'Gaming Headsets', items: [
      ...
      { folder: 'headphones', file: 'g535-wireless-gallery-1.png', name: 'Logitech G635 RGB Gaming Headset', brand: 'Logitech', price: 2990000 },
    ...
    { categoryName: 'Gaming Furniture', items: [
      { folder: 'funiture', file: 'ChairPro.webp', name: 'Corsair TC500 LUXE Gaming Chair', brand: 'Corsair', price: 9900000, sale: 8490000 },
    ...
    { categoryName: 'Prebuilt PCs', items: [
      ...
      { folder: 'PCs', file: 'h7-flow-hero-white.png', name: 'Pecify Mini — ITX RTX 4060 Build', brand: 'Pecify', price: 32990000, sale: 29990000 },
    ]},
  ];
